...
static void create_example_r_config(struct lt_config_t *r_config)
{
    ...
    r_config->obj[CONFIGURATION_OBJECTS_CFG_START_UP_IDX]
    ...
    r_config->obj[CONFIGURATION_OBJECTS_CFG_SENSORS_IDX] &= ~(
    ...
    //-------CFG_DEBUG---------------------------------------
    // Disable FW logging
    r_config->obj[CONFIGURATION_OBJECTS_CFG_DEBUG_IDX] &= ~BOOTLOADER_CO_CFG_DEBUG_FW_LOG_EN_MASK;
    ...
    // Enable sleep mode
    r_config->obj[CONFIGURATION_OBJECTS_CFG_SLEEP_MODE_IDX] |= APPLICATION_CO_CFG_SLEEP_MODE_SLEEP_MODE_EN_MASK;

    //------- CONFIGURATION_OBJECTS_CFG_UAP_PAIRING_KEY_WRITE ---------------------
    // Disable writing pairing keys for all slots
    r_config->obj[CONFIGURATION_OBJECTS_CFG_UAP_PAIRING_KEY_WRITE_IDX] &= ~TO_PAIRING_KEY_SH0(
        SESSION_SH0_HAS_ACCESS | SESSION_SH1_HAS_ACCESS | SESSION_SH2_HAS_ACCESS | SESSION_SH3_HAS_ACCESS);
    r_config->obj[CONFIGURATION_OBJECTS_CFG_UAP_PAIRING_KEY_WRITE_IDX] &= ~TO_PAIRING_KEY_SH1(
        SESSION_SH0_HAS_ACCESS | SESSION_SH1_HAS_ACCESS | SESSION_SH2_HAS_ACCESS | SESSION_SH3_HAS_ACCESS);
    r_config->obj[CONFIGURATION_OBJECTS_CFG_UAP_PAIRING_KEY_WRITE_IDX] &= ~TO_PAIRING_KEY_SH2(
        SESSION_SH0_HAS_ACCESS | SESSION_SH1_HAS_ACCESS | SESSION_SH2_HAS_ACCESS | SESSION_SH3_HAS_ACCESS);
    r_config->obj[CONFIGURATION_OBJECTS_CFG_UAP_PAIRING_KEY_WRITE_IDX] &= ~TO_PAIRING_KEY_SH3(
        SESSION_SH0_HAS_ACCESS | SESSION_SH1_HAS_ACCESS | SESSION_SH2_HAS_ACCESS | SESSION_SH3_HAS_ACCESS);

    //------- CONFIGURATION_OBJECTS_CFG_UAP_PAIRING_KEY_READ ----------------------
    // All sessions can read pairing keys
    r_config->obj[CONFIGURATION_OBJECTS_CFG_UAP_PAIRING_KEY_READ_IDX] |= TO_PAIRING_KEY_SH0(
        SESSION_SH0_HAS_ACCESS | SESSION_SH1_HAS_ACCESS | SESSION_SH2_HAS_ACCESS | SESSION_SH3_HAS_ACCESS);
    r_config->obj[CONFIGURATION_OBJECTS_CFG_UAP_PAIRING_KEY_READ_IDX] |= TO_PAIRING_KEY_SH1(
        SESSION_SH0_HAS_ACCESS | SESSION_SH1_HAS_ACCESS | SESSION_SH2_HAS_ACCESS | SESSION_SH3_HAS_ACCESS);
    r_config->obj[CONFIGURATION_OBJECTS_CFG_UAP_PAIRING_KEY_READ_IDX] |= TO_PAIRING_KEY_SH2(
        SESSION_SH0_HAS_ACCESS | SESSION_SH1_HAS_ACCESS | SESSION_SH2_HAS_ACCESS | SESSION_SH3_HAS_ACCESS);
    r_config->obj[CONFIGURATION_OBJECTS_CFG_UAP_PAIRING_KEY_READ_IDX] |= TO_PAIRING_KEY_SH3(
        SESSION_SH0_HAS_ACCESS | SESSION_SH1_HAS_ACCESS | SESSION_SH2_HAS_ACCESS | SESSION_SH3_HAS_ACCESS);

    //------- CONFIGURATION_OBJECTS_CFG_UAP_PAIRING_KEY_INVALIDATE ----------------
    // 1. Disable all, then enable only specific ones
    r_config->obj[CONFIGURATION_OBJECTS_CFG_UAP_PAIRING_KEY_INVALIDATE_IDX] &= ~TO_PAIRING_KEY_SH0(
        SESSION_SH0_HAS_ACCESS | SESSION_SH1_HAS_ACCESS | SESSION_SH2_HAS_ACCESS | SESSION_SH3_HAS_ACCESS);
    r_config->obj[CONFIGURATION_OBJECTS_CFG_UAP_PAIRING_KEY_INVALIDATE_IDX] &= ~TO_PAIRING_KEY_SH1(
        SESSION_SH0_HAS_ACCESS | SESSION_SH1_HAS_ACCESS | SESSION_SH2_HAS_ACCESS | SESSION_SH3_HAS_ACCESS);
    r_config->obj[CONFIGURATION_OBJECTS_CFG_UAP_PAIRING_KEY_INVALIDATE_IDX] &= ~TO_PAIRING_KEY_SH2(
        SESSION_SH0_HAS_ACCESS | SESSION_SH1_HAS_ACCESS | SESSION_SH2_HAS_ACCESS | SESSION_SH3_HAS_ACCESS);
    r_config->obj[CONFIGURATION_OBJECTS_CFG_UAP_PAIRING_KEY_INVALIDATE_IDX] &= ~TO_PAIRING_KEY_SH3(
        SESSION_SH0_HAS_ACCESS | SESSION_SH1_HAS_ACCESS | SESSION_SH2_HAS_ACCESS | SESSION_SH3_HAS_ACCESS);
    // 2. Pairing key SH0PUB can be invalidated only from session with SH0PUB
    r_config->obj[CONFIGURATION_OBJECTS_CFG_UAP_PAIRING_KEY_INVALIDATE_IDX]
        |= TO_PAIRING_KEY_SH0(SESSION_SH0_HAS_ACCESS);
    // 3. Pairing keys SH1PUB, SH2PUB and SH3PUB can be invalidated only from session with SH3PUB
    r_config->obj[CONFIGURATION_OBJECTS_CFG_UAP_PAIRING_KEY_INVALIDATE_IDX]
        |= TO_PAIRING_KEY_SH1(SESSION_SH3_HAS_ACCESS);
    r_config->obj[CONFIGURATION_OBJECTS_CFG_UAP_PAIRING_KEY_INVALIDATE_IDX]
        |= TO_PAIRING_KEY_SH2(SESSION_SH3_HAS_ACCESS);
    r_config->obj[CONFIGURATION_OBJECTS_CFG_UAP_PAIRING_KEY_INVALIDATE_IDX]
        |= TO_PAIRING_KEY_SH3(SESSION_SH3_HAS_ACCESS);
    ...
    r_config->obj[CONFIGURATION_OBJECTS_CFG_UAP_PING_IDX]
        |= (SESSION_SH0_HAS_ACCESS | SESSION_SH1_HAS_ACCESS | SESSION_SH2_HAS_ACCESS | SESSION_SH3_HAS_ACCESS);
    ...
    // Enable for all pairing keys
    r_config->obj[CONFIGURATION_OBJECTS_CFG_UAP_RANDOM_VALUE_GET_IDX]
        |= (SESSION_SH0_HAS_ACCESS | SESSION_SH1_HAS_ACCESS | SESSION_SH2_HAS_ACCESS | SESSION_SH3_HAS_ACCESS);

    //------- CONFIGURATION_OBJECTS_CFG_UAP_ECC_KEY_GENERATE ----------------------
    // 1. Disable all, then enable only specific ones
    r_config->obj[CONFIGURATION_OBJECTS_CFG_UAP_ECC_KEY_GENERATE_IDX] &= ~TO_ECC_KEY_SLOT_0_7(
        SESSION_SH0_HAS_ACCESS | SESSION_SH1_HAS_ACCESS | SESSION_SH2_HAS_ACCESS | SESSION_SH3_HAS_ACCESS);
    r_config->obj[CONFIGURATION_OBJECTS_CFG_UAP_ECC_KEY_GENERATE_IDX] &= ~TO_ECC_KEY_SLOT_8_15(
        SESSION_SH0_HAS_ACCESS | SESSION_SH1_HAS_ACCESS | SESSION_SH2_HAS_ACCESS | SESSION_SH3_HAS_ACCESS);
    r_config->obj[CONFIGURATION_OBJECTS_CFG_UAP_ECC_KEY_GENERATE_IDX] &= ~TO_ECC_KEY_SLOT_16_23(
        SESSION_SH0_HAS_ACCESS | SESSION_SH1_HAS_ACCESS | SESSION_SH2_HAS_ACCESS | SESSION_SH3_HAS_ACCESS);
    r_config->obj[CONFIGURATION_OBJECTS_CFG_UAP_ECC_KEY_GENERATE_IDX] &= ~TO_ECC_KEY_SLOT_24_31(
        SESSION_SH0_HAS_ACCESS | SESSION_SH1_HAS_ACCESS | SESSION_SH2_HAS_ACCESS | SESSION_SH3_HAS_ACCESS);
    // 2. Only session with SH3PUB can generate keys in slots 8-31
    r_config->obj[CONFIGURATION_OBJECTS_CFG_UAP_ECC_KEY_GENERATE_IDX]
        |= (TO_ECC_KEY_SLOT_8_15(SESSION_SH3_HAS_ACCESS) | TO_ECC_KEY_SLOT_16_23(SESSION_SH3_HAS_ACCESS)
            | TO_ECC_KEY_SLOT_24_31(SESSION_SH3_HAS_ACCESS));

    //------- CONFIGURATION_OBJECTS_CFG_UAP_ECC_KEY_STORE -------------------------
    // 1. Disable all, then enable only specific ones
    r_config->obj[CONFIGURATION_OBJECTS_CFG_UAP_ECC_KEY_STORE_IDX] &= ~TO_ECC_KEY_SLOT_0_7(
        SESSION_SH0_HAS_ACCESS | SESSION_SH1_HAS_ACCESS | SESSION_SH2_HAS_ACCESS | SESSION_SH3_HAS_ACCESS);
    r_config->obj[CONFIGURATION_OBJECTS_CFG_UAP_ECC_KEY_STORE_IDX] &= ~TO_ECC_KEY_SLOT_8_15(
        SESSION_SH0_HAS_ACCESS | SESSION_SH1_HAS_ACCESS | SESSION_SH2_HAS_ACCESS | SESSION_SH3_HAS_ACCESS);
    r_config->obj[CONFIGURATION_OBJECTS_CFG_UAP_ECC_KEY_STORE_IDX] &= ~TO_ECC_KEY_SLOT_16_23(
        SESSION_SH0_HAS_ACCESS | SESSION_SH1_HAS_ACCESS | SESSION_SH2_HAS_ACCESS | SESSION_SH3_HAS_ACCESS);
    r_config->obj[CONFIGURATION_OBJECTS_CFG_UAP_ECC_KEY_STORE_IDX] &= ~TO_ECC_KEY_SLOT_24_31(
        SESSION_SH0_HAS_ACCESS | SESSION_SH1_HAS_ACCESS | SESSION_SH2_HAS_ACCESS | SESSION_SH3_HAS_ACCESS);
    // 2. Session with SH1PUB can store key into ECC key slot 0-7
    r_config->obj[CONFIGURATION_OBJECTS_CFG_UAP_ECC_KEY_STORE_IDX] |= TO_ECC_KEY_SLOT_0_7(SESSION_SH1_HAS_ACCESS);
    // 3. Session with SH3PUB can store key into ECC key slot 8-31
    r_config->obj[CONFIGURATION_OBJECTS_CFG_UAP_ECC_KEY_STORE_IDX] |= TO_ECC_KEY_SLOT_8_15(SESSION_SH3_HAS_ACCESS)
                                                                      | TO_ECC_KEY_SLOT_16_23(SESSION_SH3_HAS_ACCESS)
                                                                      | TO_ECC_KEY_SLOT_24_31(SESSION_SH3_HAS_ACCESS);

    //------- CONFIGURATION_OBJECTS_CFG_UAP_ECC_KEY_READ --------------------------
    // Enable for all pairing keys
    r_config->obj[CONFIGURATION_OBJECTS_CFG_UAP_ECC_KEY_READ_IDX] |= TO_ECC_KEY_SLOT_0_7(
        SESSION_SH0_HAS_ACCESS | SESSION_SH1_HAS_ACCESS | SESSION_SH2_HAS_ACCESS | SESSION_SH3_HAS_ACCESS);
    r_config->obj[CONFIGURATION_OBJECTS_CFG_UAP_ECC_KEY_READ_IDX] |= TO_ECC_KEY_SLOT_8_15(
        SESSION_SH0_HAS_ACCESS | SESSION_SH1_HAS_ACCESS | SESSION_SH2_HAS_ACCESS | SESSION_SH3_HAS_ACCESS);
    r_config->obj[CONFIGURATION_OBJECTS_CFG_UAP_ECC_KEY_READ_IDX] |= TO_ECC_KEY_SLOT_16_23(
        SESSION_SH0_HAS_ACCESS | SESSION_SH1_HAS_ACCESS | SESSION_SH2_HAS_ACCESS | SESSION_SH3_HAS_ACCESS);
    r_config->obj[CONFIGURATION_OBJECTS_CFG_UAP_ECC_KEY_READ_IDX] |= TO_ECC_KEY_SLOT_24_31(
        SESSION_SH0_HAS_ACCESS | SESSION_SH1_HAS_ACCESS | SESSION_SH2_HAS_ACCESS | SESSION_SH3_HAS_ACCESS);

    //------- CONFIGURATION_OBJECTS_CFG_UAP_ECC_KEY_ERASE -------------------------
    // 1. Disable all, then enable only specific ones
    r_config->obj[CONFIGURATION_OBJECTS_CFG_UAP_ECC_KEY_ERASE_IDX] &= ~TO_ECC_KEY_SLOT_0_7(
        SESSION_SH0_HAS_ACCESS | SESSION_SH1_HAS_ACCESS | SESSION_SH2_HAS_ACCESS | SESSION_SH3_HAS_ACCESS);
    r_config->obj[CONFIGURATION_OBJECTS_CFG_UAP_ECC_KEY_ERASE_IDX] &= ~TO_ECC_KEY_SLOT_8_15(
        SESSION_SH0_HAS_ACCESS | SESSION_SH1_HAS_ACCESS | SESSION_SH2_HAS_ACCESS | SESSION_SH3_HAS_ACCESS);
    r_config->obj[CONFIGURATION_OBJECTS_CFG_UAP_ECC_KEY_ERASE_IDX] &= ~TO_ECC_KEY_SLOT_16_23(
        SESSION_SH0_HAS_ACCESS | SESSION_SH1_HAS_ACCESS | SESSION_SH2_HAS_ACCESS | SESSION_SH3_HAS_ACCESS);
    r_config->obj[CONFIGURATION_OBJECTS_CFG_UAP_ECC_KEY_ERASE_IDX] &= ~TO_ECC_KEY_SLOT_24_31(
        SESSION_SH0_HAS_ACCESS | SESSION_SH1_HAS_ACCESS | SESSION_SH2_HAS_ACCESS | SESSION_SH3_HAS_ACCESS);
    // 2. Session with SH1PUB can erase ECC key slots 0-7
    r_config->obj[CONFIGURATION_OBJECTS_CFG_UAP_ECC_KEY_ERASE_IDX] |= TO_ECC_KEY_SLOT_0_7(SESSION_SH1_HAS_ACCESS);
    // 3. Session with SH3PUB can erase ECC key slots 8-31
    r_config->obj[CONFIGURATION_OBJECTS_CFG_UAP_ECC_KEY_ERASE_IDX] |= TO_ECC_KEY_SLOT_8_15(SESSION_SH3_HAS_ACCESS)
                                                                      | TO_ECC_KEY_SLOT_16_23(SESSION_SH3_HAS_ACCESS)
                                                                      | TO_ECC_KEY_SLOT_24_31(SESSION_SH3_HAS_ACCESS);

    //------- CONFIGURATION_OBJECTS_CFG_UAP_ECDSA_SIGN ----------------------------
    // 1. Disable all, then enable only specific ones
    r_config->obj[CONFIGURATION_OBJECTS_CFG_UAP_ECDSA_SIGN_IDX] &= ~TO_ECC_KEY_SLOT_0_7(
        SESSION_SH0_HAS_ACCESS | SESSION_SH1_HAS_ACCESS | SESSION_SH2_HAS_ACCESS | SESSION_SH3_HAS_ACCESS);
    r_config->obj[CONFIGURATION_OBJECTS_CFG_UAP_ECDSA_SIGN_IDX] &= ~TO_ECC_KEY_SLOT_8_15(
        SESSION_SH0_HAS_ACCESS | SESSION_SH1_HAS_ACCESS | SESSION_SH2_HAS_ACCESS | SESSION_SH3_HAS_ACCESS);
    r_config->obj[CONFIGURATION_OBJECTS_CFG_UAP_ECDSA_SIGN_IDX] &= ~TO_ECC_KEY_SLOT_16_23(
        SESSION_SH0_HAS_ACCESS | SESSION_SH1_HAS_ACCESS | SESSION_SH2_HAS_ACCESS | SESSION_SH3_HAS_ACCESS);
    r_config->obj[CONFIGURATION_OBJECTS_CFG_UAP_ECDSA_SIGN_IDX] &= ~TO_ECC_KEY_SLOT_24_31(
        SESSION_SH0_HAS_ACCESS | SESSION_SH1_HAS_ACCESS | SESSION_SH2_HAS_ACCESS | SESSION_SH3_HAS_ACCESS);
    // 2. Session with SH3PUB can sign with all ECC key slots
    r_config->obj[CONFIGURATION_OBJECTS_CFG_UAP_ECDSA_SIGN_IDX]
    ...
    // 1. Disable all, then enable only specific ones
    r_config->obj[CONFIGURATION_OBJECTS_CFG_UAP_EDDSA_SIGN_IDX] &= ~TO_ECC_KEY_SLOT_0_7(
        SESSION_SH0_HAS_ACCESS | SESSION_SH1_HAS_ACCESS | SESSION_SH2_HAS_ACCESS | SESSION_SH3_HAS_ACCESS);
    r_config->obj[CONFIGURATION_OBJECTS_CFG_UAP_EDDSA_SIGN_IDX] &= ~TO_ECC_KEY_SLOT_8_15(
        SESSION_SH0_HAS_ACCESS | SESSION_SH1_HAS_ACCESS | SESSION_SH2_HAS_ACCESS | SESSION_SH3_HAS_ACCESS);
    r_config->obj[CONFIGURATION_OBJECTS_CFG_UAP_EDDSA_SIGN_IDX] &= ~TO_ECC_KEY_SLOT_16_23(
        SESSION_SH0_HAS_ACCESS | SESSION_SH1_HAS_ACCESS | SESSION_SH2_HAS_ACCESS | SESSION_SH3_HAS_ACCESS);
    r_config->obj[CONFIGURATION_OBJECTS_CFG_UAP_EDDSA_SIGN_IDX] &= ~TO_ECC_KEY_SLOT_24_31(
        SESSION_SH0_HAS_ACCESS | SESSION_SH1_HAS_ACCESS | SESSION_SH2_HAS_ACCESS | SESSION_SH3_HAS_ACCESS);
    // 2. Session with SH3PUB can sign with all ECC key slots
    r_config->obj[CONFIGURATION_OBJECTS_CFG_UAP_EDDSA_SIGN_IDX]
        |= (TO_ECC_KEY_SLOT_0_7(SESSION_SH3_HAS_ACCESS) | TO_ECC_KEY_SLOT_8_15(SESSION_SH3_HAS_ACCESS)
            | TO_ECC_KEY_SLOT_16_23(SESSION_SH3_HAS_ACCESS) | TO_ECC_KEY_SLOT_24_31(SESSION_SH3_HAS_ACCESS));

    //------- CONFIGURATION_OBJECTS_CFG_UAP_MCOUNTER_INIT -------------------------
    // 1. Disable all, then enable only specific ones
    r_config->obj[CONFIGURATION_OBJECTS_CFG_UAP_MCOUNTER_INIT_IDX] &= ~TO_LT_MCOUNTER_0_3(
        SESSION_SH0_HAS_ACCESS | SESSION_SH1_HAS_ACCESS | SESSION_SH2_HAS_ACCESS | SESSION_SH3_HAS_ACCESS);
    r_config->obj[CONFIGURATION_OBJECTS_CFG_UAP_MCOUNTER_INIT_IDX] &= ~TO_LT_MCOUNTER_4_7(
        SESSION_SH0_HAS_ACCESS | SESSION_SH1_HAS_ACCESS | SESSION_SH2_HAS_ACCESS | SESSION_SH3_HAS_ACCESS);
    r_config->obj[CONFIGURATION_OBJECTS_CFG_UAP_MCOUNTER_INIT_IDX] &= ~TO_LT_MCOUNTER_8_11(
        SESSION_SH0_HAS_ACCESS | SESSION_SH1_HAS_ACCESS | SESSION_SH2_HAS_ACCESS | SESSION_SH3_HAS_ACCESS);
    r_config->obj[CONFIGURATION_OBJECTS_CFG_UAP_MCOUNTER_INIT_IDX] &= ~TO_LT_MCOUNTER_12_15(
        SESSION_SH0_HAS_ACCESS | SESSION_SH1_HAS_ACCESS | SESSION_SH2_HAS_ACCESS | SESSION_SH3_HAS_ACCESS);
    // 2. Session with SH3PUB can init all mcounters
    r_config->obj[CONFIGURATION_OBJECTS_CFG_UAP_MCOUNTER_INIT_IDX]
    ...
    // 1. Disable all, then enable only specific ones
    r_config->obj[CONFIGURATION_OBJECTS_CFG_UAP_MCOUNTER_GET_IDX] &= ~TO_LT_MCOUNTER_0_3(
        SESSION_SH0_HAS_ACCESS | SESSION_SH1_HAS_ACCESS | SESSION_SH2_HAS_ACCESS | SESSION_SH3_HAS_ACCESS);
    r_config->obj[CONFIGURATION_OBJECTS_CFG_UAP_MCOUNTER_GET_IDX] &= ~TO_LT_MCOUNTER_4_7(
        SESSION_SH0_HAS_ACCESS | SESSION_SH1_HAS_ACCESS | SESSION_SH2_HAS_ACCESS | SESSION_SH3_HAS_ACCESS);
    r_config->obj[CONFIGURATION_OBJECTS_CFG_UAP_MCOUNTER_GET_IDX] &= ~TO_LT_MCOUNTER_8_11(
        SESSION_SH0_HAS_ACCESS | SESSION_SH1_HAS_ACCESS | SESSION_SH2_HAS_ACCESS | SESSION_SH3_HAS_ACCESS);
    r_config->obj[CONFIGURATION_OBJECTS_CFG_UAP_MCOUNTER_GET_IDX] &= ~TO_LT_MCOUNTER_12_15(
        SESSION_SH0_HAS_ACCESS | SESSION_SH1_HAS_ACCESS | SESSION_SH2_HAS_ACCESS | SESSION_SH3_HAS_ACCESS);
    // 2. Session with SH3PUB can get all mcounters
    r_config->obj[CONFIGURATION_OBJECTS_CFG_UAP_MCOUNTER_GET_IDX]
        |= (TO_LT_MCOUNTER_0_3(SESSION_SH3_HAS_ACCESS) | TO_LT_MCOUNTER_4_7(SESSION_SH3_HAS_ACCESS)
            | TO_LT_MCOUNTER_8_11(SESSION_SH3_HAS_ACCESS) | TO_LT_MCOUNTER_12_15(SESSION_SH3_HAS_ACCESS));

    //------- CONFIGURATION_OBJECTS_CFG_UAP_MCOUNTER_UPDATE -----------------------
    // 1. Disable all, then enable only specific ones
    r_config->obj[CONFIGURATION_OBJECTS_CFG_UAP_MCOUNTER_UPDATE_IDX] &= ~TO_LT_MCOUNTER_0_3(
        SESSION_SH0_HAS_ACCESS | SESSION_SH1_HAS_ACCESS | SESSION_SH2_HAS_ACCESS | SESSION_SH3_HAS_ACCESS);
    r_config->obj[CONFIGURATION_OBJECTS_CFG_UAP_MCOUNTER_UPDATE_IDX] &= ~TO_LT_MCOUNTER_4_7(
        SESSION_SH0_HAS_ACCESS | SESSION_SH1_HAS_ACCESS | SESSION_SH2_HAS_ACCESS | SESSION_SH3_HAS_ACCESS);
    r_config->obj[CONFIGURATION_OBJECTS_CFG_UAP_MCOUNTER_UPDATE_IDX] &= ~TO_LT_MCOUNTER_8_11(
        SESSION_SH0_HAS_ACCESS | SESSION_SH1_HAS_ACCESS | SESSION_SH2_HAS_ACCESS | SESSION_SH3_HAS_ACCESS);
    r_config->obj[CONFIGURATION_OBJECTS_CFG_UAP_MCOUNTER_UPDATE_IDX] &= ~TO_LT_MCOUNTER_12_15(
        SESSION_SH0_HAS_ACCESS | SESSION_SH1_HAS_ACCESS | SESSION_SH2_HAS_ACCESS | SESSION_SH3_HAS_ACCESS);
    // 2. Session with SH3PUB can update all mcounters
    r_config->obj[CONFIGURATION_OBJECTS_CFG_UAP_MCOUNTER_UPDATE_IDX]
        |= (TO_LT_MCOUNTER_0_3(SESSION_SH3_HAS_ACCESS) | TO_LT_MCOUNTER_4_7(SESSION_SH3_HAS_ACCESS)
            | TO_LT_MCOUNTER_8_11(SESSION_SH3_HAS_ACCESS) | TO_LT_MCOUNTER_12_15(SESSION_SH3_HAS_ACCESS));

    //------- CONFIGURATION_OBJECTS_CFG_UAP_MAC_AND_DESTROY_ADDR -----------------------
    // Enable for all pairing key slots
    r_config->obj[CONFIGURATION_OBJECTS_CFG_UAP_MAC_AND_DESTROY_IDX] |= TO_MACANDD_SLOT_0_31(
        SESSION_SH0_HAS_ACCESS | SESSION_SH1_HAS_ACCESS | SESSION_SH2_HAS_ACCESS | SESSION_SH3_HAS_ACCESS);
    r_config->obj[CONFIGURATION_OBJECTS_CFG_UAP_MAC_AND_DESTROY_IDX] |= TO_MACANDD_SLOT_32_63(
        SESSION_SH0_HAS_ACCESS | SESSION_SH1_HAS_ACCESS | SESSION_SH2_HAS_ACCESS | SESSION_SH3_HAS_ACCESS);
    r_config->obj[CONFIGURATION_OBJECTS_CFG_UAP_MAC_AND_DESTROY_IDX] |= TO_MACANDD_SLOT_64_95(
        SESSION_SH0_HAS_ACCESS | SESSION_SH1_HAS_ACCESS | SESSION_SH2_HAS_ACCESS | SESSION_SH3_HAS_ACCESS);
    r_config->obj[CONFIGURATION_OBJECTS_CFG_UAP_MAC_AND_DESTROY_IDX] |= TO_MACANDD_SLOT_96_127(
        SESSION_SH0_HAS_ACCESS | SESSION_SH1_HAS_ACCESS | SESSION_SH2_HAS_ACCESS | SESSION_SH3_HAS_ACCESS);
}
