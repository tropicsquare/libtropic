...
struct lt_config_t config = {.obj={
    ...
    // H3 can generate key in slots 8-31
        (TO_ECC_KEY_SLOT_0_7(0)                  |
         TO_ECC_KEY_SLOT_8_15(SESSION_SH3_HAS_ACCESS)  |
    ...
    // H3 can store key into ecc key slot 8-31
        (TO_ECC_KEY_SLOT_0_7(SESSION_SH1_HAS_ACCESS)   |
         TO_ECC_KEY_SLOT_8_15(SESSION_SH3_HAS_ACCESS)  |
         TO_ECC_KEY_SLOT_16_23(SESSION_SH3_HAS_ACCESS) |
         TO_ECC_KEY_SLOT_24_31(SESSION_SH3_HAS_ACCESS)),
    //------- CONFIGURATION_OBJECTS_CFG_UAP_ECC_KEY_READ --------------------------
    // All keys can read pubkey
        (TO_ECC_KEY_SLOT_0_7(  SESSION_SH0_HAS_ACCESS | SESSION_SH1_HAS_ACCESS | SESSION_SH2_HAS_ACCESS | SESSION_SH3_HAS_ACCESS) |
         TO_ECC_KEY_SLOT_8_15( SESSION_SH0_HAS_ACCESS | SESSION_SH1_HAS_ACCESS | SESSION_SH2_HAS_ACCESS | SESSION_SH3_HAS_ACCESS) |
         TO_ECC_KEY_SLOT_16_23(SESSION_SH0_HAS_ACCESS | SESSION_SH1_HAS_ACCESS | SESSION_SH2_HAS_ACCESS | SESSION_SH3_HAS_ACCESS) |
         TO_ECC_KEY_SLOT_24_31(SESSION_SH0_HAS_ACCESS | SESSION_SH1_HAS_ACCESS | SESSION_SH2_HAS_ACCESS | SESSION_SH3_HAS_ACCESS)),
    ...
    // H3 can sign with all ECDSA key slots
        (TO_ECC_KEY_SLOT_0_7(  SESSION_SH3_HAS_ACCESS) |
         TO_ECC_KEY_SLOT_8_15( SESSION_SH3_HAS_ACCESS) |
         TO_ECC_KEY_SLOT_16_23(SESSION_SH3_HAS_ACCESS) |
         TO_ECC_KEY_SLOT_24_31(SESSION_SH3_HAS_ACCESS)),
    ...
    // H3 can init all counters
        (TO_LT_MCOUNTER_0_3(  SESSION_SH3_HAS_ACCESS) |
         TO_LT_MCOUNTER_4_7( SESSION_SH3_HAS_ACCESS)  |
         TO_LT_MCOUNTER_8_11(SESSION_SH3_HAS_ACCESS)  |
         TO_LT_MCOUNTER_12_15(SESSION_SH3_HAS_ACCESS)),
