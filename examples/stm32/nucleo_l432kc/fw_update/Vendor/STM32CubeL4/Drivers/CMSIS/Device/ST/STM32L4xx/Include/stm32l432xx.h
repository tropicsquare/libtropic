...
typedef struct {
    uint32_t RESERVED1; /*!< Reserved,                                      Address offset: ADC1 base
                           address + 0x300 */
    uint32_t RESERVED2; /*!< Reserved,                                      Address offset: ADC1 base
                           address + 0x304 */
    __IO uint32_t CCR;  /*!< ADC common configuration register,             Address offset: ADC1 base
                           address + 0x308 */
    uint32_t RESERVED3; /*!< Reserved,                                      Address offset: ADC1 base
                           address + 0x30C */
} ADC_Common_TypeDef;
...
typedef struct {
    __IO uint32_t CSR; /*!< OPAMP control/status register, used for bits common to several OPAMP
                          instances, Address offset: 0x00 */
...
typedef struct {
    ...
    __IO uint32_t AHB1SMENR; /*!< RCC AHB1 peripheral clocks enable in sleep and stop modes register,
                                Address offset: 0x68 */
    __IO uint32_t AHB2SMENR; /*!< RCC AHB2 peripheral clocks enable in sleep and stop modes register,
                                Address offset: 0x6C */
    __IO uint32_t AHB3SMENR; /*!< RCC AHB3 peripheral clocks enable in sleep and stop modes register,
                                Address offset: 0x70 */
    ...
    __IO uint32_t CCIPR; /*!< RCC peripherals independent clock configuration register, Address offset:
                            0x88 */
...
typedef struct {
    ...
    uint32_t RESERVED3; /*!< Reserved,                                                 Address offset:
                           0x24 */
    __IO uint32_t
        IOCCR; /*!< TSC I/O channel control register,                         Address offset: 0x28 */
    uint32_t RESERVED4; /*!< Reserved,                                                 Address offset:
                           0x2C */
    __IO uint32_t
...
#define ADC_CFGR2_TROVS                                                                         \
    ADC_CFGR2_TROVS_Msk /*!< ADC oversampling discontinuous mode (triggered mode) for ADC group \
                           regular */
#define ADC_CFGR2_ROVSM_Pos (10U)
#define ADC_CFGR2_ROVSM_Msk (0x1UL << ADC_CFGR2_ROVSM_Pos) /*!< 0x00000400 */
#define ADC_CFGR2_ROVSM                                                                         \
    ADC_CFGR2_ROVSM_Msk /*!< ADC oversampling mode managing interlaced conversions of ADC group \
                           regular and group injected */
...
#define ADC_CCR_CKMODE                                                                             \
    ADC_CCR_CKMODE_Msk /*!< ADC common clock source and prescaler (prescaler only for clock source \
                          synchronous) */
...
#define COMP_CSR_WINMODE                                                                         \
    COMP_CSR_WINMODE_Msk /*!< Pair of comparators window mode. Bit intended to be used with COMP \
                            common instance (COMP_Common_TypeDef)  */
...
#define OPAMP1_CSR_OPARANGE                                                                       \
    OPAMP1_CSR_OPARANGE_Msk /*!< Common to several OPAMP instances: Operational amplifier voltage \
                               supply range. Bit intended to be used with OPAMP common instance   \
                               (OPAMP_Common_TypeDef) */
...
#define SWPMI_RFL_RFL_0_1                                                                             \
    SWPMI_RFL_RFL_0_1_Msk /*!<RFL[1:0] bits (number of relevant bytes for the last SWPMI_RDR register \
                             read.) */
...
#define IS_GPIO_ALL_INSTANCE(INSTANCE) \
    (((INSTANCE) == GPIOA) || ((INSTANCE) == GPIOB) || ((INSTANCE) == GPIOC) || ((INSTANCE) == GPIOH))
...
#define IS_TIM_INSTANCE(INSTANCE)                                                                    \
    (((INSTANCE) == TIM1) || ((INSTANCE) == TIM2) || ((INSTANCE) == TIM6) || ((INSTANCE) == TIM7) || \
