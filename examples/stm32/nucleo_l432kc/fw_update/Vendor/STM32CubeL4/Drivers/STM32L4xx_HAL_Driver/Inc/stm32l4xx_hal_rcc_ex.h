...
typedef struct {
    ...
    uint32_t Sdmmc1ClockSelection; /*!< Specifies SDMMC1 clock source (warning: same source for USB and
                                      RNG). This parameter can be a value of @ref
...
typedef struct {
    ...
    uint32_t ReloadValue; /*!< Specifies the value to be loaded in the frequency error counter with
                             ...
                             __HAL_RCC_CRS_RELOADVALUE_CALCULATE(__FTARGET__, __FSYNC__) This parameter
                             must be a number between 0 and 0xFFFF or a value of @ref
                             RCCEx_CRS_ReloadValueDefault .*/

    uint32_t ErrorLimitValue; /*!< Specifies the value to be used to evaluate the captured frequency
                                 error value. This parameter must be a number between 0 and 0xFF or a
                                 value of @ref RCCEx_CRS_ErrorLimitDefault */

    uint32_t HSI48CalibrationValue; /*!< Specifies a user-programmable trimming value to the HSI48
                                       oscillator. This parameter must be a number between 0 and 0x7F
                                       for STM32L412xx/L422xx, between 0 and 0x3F otherwise, or a value
                                       of @ref RCCEx_CRS_HSI48CalibrationDefault */
...
typedef struct {
    ...
    uint32_t
        FreqErrorCapture; /*!< Specifies the value loaded in the .FECAP, the frequency error counter
                                                            value latched in the time of the last SYNC
                            event. This parameter must be a number between 0 and 0xFFFF */

    uint32_t FreqErrorDirection; /*!< Specifies the value loaded in the .FEDIR, the counting direction
...
#define RCC_CRS_HSI48CALIBRATION_DEFAULT                                                      \
    0x00000040U /*!< The default value is 64, which corresponds to the middle of the trimming \
                   interval. The trimming step is specified in the product datasheet. A higher TRIM                       \
                   value corresponds to a higher output frequency */
#else
#define RCC_CRS_HSI48CALIBRATION_DEFAULT                                                      \
 ...
 *            @arg @ref RCC_PLLSAI1_48M2CLK  This clock is used to generate the clock for the USB OTG
 * FS (48 MHz), the random number generator (<=48 MHz) and the SDIO (<= 48 MHz).
...
/** @brief  Macro to get the SDMMC1 clock.
  ...
  *            @arg @ref RCC_SDMMC1CLKSOURCE_NONE  No clock selected as SDMMC1 clock for devices
  without HSI48
  *            @arg @ref RCC_SDMMC1CLKSOURCE_MSI  MSI selected as SDMMC1 clock
  *            @arg @ref RCC_SDMMC1CLKSOURCE_PLLSAI1  PLLSAI1 "Q" clock (PLL48M2CLK) selected as SDMMC1
  clock
  @endif
  @if STM32L443xx
  *            @arg @ref RCC_SDMMC1CLKSOURCE_HSI48  HSI48 selected as SDMMC1 clock for devices with
  ...
  *            @arg @ref RCC_SDMMC1CLKSOURCE_PLLSAI1  PLLSAI1 "Q" clock (PLL48M2CLK) selected as SDMMC1
  clock
  *            @arg @ref RCC_SDMMC1CLKSOURCE_PLLP  PLL "P" clock (PLLSAI3CLK) selected as SDMMC1 kernel
  clock
  @endif
 ...
 *         This parameter can be one of the following values:
 *            @arg @ref RCC_LTDCCLKSOURCE_PLLSAI2_DIV2   PLLSAI2 divider R divided by 2 clock selected
 * as LTDC clock
 *            @arg @ref RCC_LTDCCLKSOURCE_PLLSAI2_DIV4   PLLSAI2 divider R divided by 4 clock selected
 * as LTDC clock
 *            @arg @ref RCC_LTDCCLKSOURCE_PLLSAI2_DIV8   PLLSAI2 divider R divided by 8 clock selected
 * as LTDC clock
 *            @arg @ref RCC_LTDCCLKSOURCE_PLLSAI2_DIV16  PLLSAI2 divider R divided by 16 clock selected
 * as LTDC clock
 * @retval None
 */
 ...
 * frequencies
 * @note   The RELOAD value should be selected according to the ratio between the target frequency and
 * the frequency of the synchronization source after prescaling. It is then decreased by one in order
 * to reach the expected synchronization on the zero value. The formula is the following: RELOAD =
 * (fTARGET / fSYNC) -1
