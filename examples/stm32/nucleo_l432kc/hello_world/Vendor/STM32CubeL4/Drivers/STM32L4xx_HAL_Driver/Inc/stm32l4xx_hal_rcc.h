...
typedef struct {
    ...
    uint32_t PLLM; /*!< PLLM: Division factor for PLL VCO input clock.
                      ...
                      STM32L4Rx/STM32L4Sx devices. This parameter must be a number between Min_Data = 1
                      and Max_Data = 8 on the other devices */
...
#else
#define RCC_HSICALIBRATION_DEFAULT                                                                  \
    0x10U /*!< Default HSI calibration trimming value 16 on STM32L43x/STM32L44x/STM32L47x/STM32L48x \
             devices */
...
/** @defgroup RCC_AHB1_Peripheral_Clock_Enable_Disable_Status AHB1 Peripheral Clock Enabled or Disabled
 * Status
 ...
 *         This parameter must be a number between Min_Data = 1 and Max_Data = 16 on
 * STM32L4Rx/STM32L4Sx devices. This parameter must be a number between Min_Data = 1 and Max_Data = 8
 * on other devices.
...
#define __HAL_RCC_PLL_CONFIG(__PLLSOURCE__, __PLLM__, __PLLN__, __PLLP__, __PLLQ__, __PLLR__)         \
    MODIFY_REG(                                                                                       \
        ...
        ((__PLLSOURCE__) | (((__PLLM__)-1U) << RCC_PLLCFGR_PLLM_Pos) |                                \
         ((__PLLN__) << RCC_PLLCFGR_PLLN_Pos) | ((((__PLLQ__) >> 1U) - 1U) << RCC_PLLCFGR_PLLQ_Pos) | \
 ...
 *            @arg @ref RCC_PLL_SYSCLK  This Clock is used to generate the high speed system clock (up
 * to 80MHz)
 * @retval None
 */
