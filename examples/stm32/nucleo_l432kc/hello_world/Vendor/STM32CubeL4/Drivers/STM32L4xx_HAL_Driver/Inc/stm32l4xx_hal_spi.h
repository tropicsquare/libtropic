...
typedef struct {
    ...
    uint32_t CRCPolynomial; /*!< Specifies the polynomial used for the CRC calculation.
                                 This parameter must be an odd number between Min_Data = 1 and Max_Data
                               = 65535 */
 ...
 * @param  __BIT__ specifies the SPI MSB LSB transmission (whether data transfer starts from MSB or LSB
 * bit). This parameter can be a value of @ref SPI_MSB_LSB_transmission
 * @retval None
 */
