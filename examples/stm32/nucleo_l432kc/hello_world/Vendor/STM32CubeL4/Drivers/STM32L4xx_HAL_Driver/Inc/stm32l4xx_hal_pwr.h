...
/** @brief  Check whether or not a specific PWR flag is set.
  ...
  *            @arg @ref PWR_FLAG_EXT_SMPS External SMPS Ready Flag. When available on device,
  indicates
  *                 that external switch can be closed to connect to the external SMPS, when the Range
  2
  ...
  *                  is below or above PVM2 threshold (applicable when VDDIO2 is present on device).
  @endif
  *            @arg @ref PWR_FLAG_PVMO3 Peripheral Voltage Monitoring Output 3. Indicates whether VDDA
  voltage is
  *                  is below or above PVM3 threshold.
  *            @arg @ref PWR_FLAG_PVMO4 Peripheral Voltage Monitoring Output 4. Indicates whether VDDA
  voltage is
