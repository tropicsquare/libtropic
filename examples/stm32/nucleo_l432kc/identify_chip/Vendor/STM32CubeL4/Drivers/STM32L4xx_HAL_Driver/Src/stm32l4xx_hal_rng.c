...
#define RNG_HTCFG \
    0x000CAA74U /*!< Recommended value for NIST compliance, refer to application note AN4230 */
#else           /* RNG_VER_3_2 */
#define RNG_HTCFG \
    0x00007274U /*!< Recommended value for NIST compliance, refer to application note AN4230 */
...
HAL_StatusTypeDef HAL_RNG_Init(RNG_HandleTypeDef *hrng)
{
    ...
    /* RNG CR register configuration. Set value in CR register for CONFIG 1, CONFIG 2 and CONFIG 3
     * values */
    ...
    MODIFY_REG(
        hrng->Instance->CR,
        RNG_CR_CED | RNG_CR_CONDRST | RNG_CR_RNG_CONFIG1 | RNG_CR_RNG_CONFIG2 | RNG_CR_RNG_CONFIG3,
