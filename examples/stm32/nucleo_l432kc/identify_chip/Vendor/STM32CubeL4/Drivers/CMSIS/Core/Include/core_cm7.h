...
/**
  ...
  interrupt. \param [in]      IRQn  Device specific interrupt number. \return             0  Interrupt
  status is not active. \return             1  Interrupt status is active. \note    IRQn must not be
  negative.
 */
...
/**
  ...
  NVIC_GetPriority(). \param [in]     PriorityGroup  Used priority group. \param [out] pPreemptPriority
  Preemptive priority value (starting from 0). \param [out]     pSubPriority  Subpriority value
  (starting from 0).
 */
...
/**
  ...
  invalidated. \param[in]   addr    address (aligned to 32-byte boundary) \param[in]   dsize   size of
...
/**
  ...
  transmitted. \param [in]     ch  Character to transmit. \returns            Character to transmit.
 */
