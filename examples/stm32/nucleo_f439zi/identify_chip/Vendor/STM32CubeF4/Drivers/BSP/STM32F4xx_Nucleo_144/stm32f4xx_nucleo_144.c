...
/** @defgroup STM32F4XX_NUCLEO_144_LOW_LEVEL_Private_TypesDefinitions STM32F4XX NUCLEO 144 LOW LEVEL
...
/** @defgroup STM32F4XX_NUCLEO_144_LOW_LEVEL_Private_Defines STM32F4XX NUCLEO 144 LOW LEVEL Private
 * Defines
 * @{
 */
...
#define __STM32F4xx_NUCLEO_BSP_VERSION                                                           \
    ((__STM32F4xx_NUCLEO_BSP_VERSION_MAIN << 24) | (__STM32F4xx_NUCLEO_BSP_VERSION_SUB1 << 16) | \
     (__STM32F4xx_NUCLEO_BSP_VERSION_SUB2 << 8) | (__STM32F4xx_NUCLEO_BSP_VERSION_RC))
...
/** @defgroup STM32F4XX_NUCLEO_144_LOW_LEVEL_Private_Macros STM32F4XX NUCLEO 144 LOW LEVEL Private
 * Macros
 * @{
 */
/**
...
/** @defgroup STM32F4XX_NUCLEO_144_LOW_LEVEL_Private_Variables STM32F4XX NUCLEO 144 LOW LEVEL Private
 * Variables
 * @{
 */
...
/** @defgroup STM32F4XX_NUCLEO_144_LOW_LEVEL_Private_FunctionPrototypes STM32F4XX NUCLEO 144 LOW LEVEL
...
/** @defgroup STM32F4XX_NUCLEO_144_LOW_LEVEL_Private_Functions STM32F4XX NUCLEO 144 LOW LEVEL Private
 * Functions
 * @{
 */
 ...
 */
uint32_t BSP_GetVersion(void) { return __STM32F4xx_NUCLEO_BSP_VERSION; }
    ...
    if (HAL_SPI_GetState(&hnucleo_Spi) == HAL_SPI_STATE_RESET) {
        ...
        /* SPI configuration constraints
           ...
           to feat these constraints SPI baudrate is set to:
              - For STM32F412ZG devices: 12,5 MHz maximum (PCLK2/SPI_BAUDRATEPRESCALER_8 = 100 MHz/8 =
           12,5 MHz)
              - For STM32F446ZE/STM32F429ZI devices: 11,25 MHz maximum (PCLK2/SPI_BAUDRATEPRESCALER_8 =
           90 MHz/8 = 11,25 MHz)
        */
 ...
 */
void BSP_JOY_DeInit(void) { ADCx_DeInit(); }
