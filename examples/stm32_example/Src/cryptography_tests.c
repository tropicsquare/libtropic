...
/* At the moment, those are still exposed in libtropic */
#include "ts_hkdf.h"
#include "ts_aesgcm.h"
#include "ts_sha256.h"
#include "ts_x25519.h"

/* Purpose of this file is to provide quick way how to run all crypto related functions on a used devkit hardware and verify their outputs. 
   In a real world scenario, cryptography interfaces will be hidden to user. 
*/
