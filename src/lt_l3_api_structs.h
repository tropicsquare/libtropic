...
/** @brief Packet length (incl. RES_SIZE and TAG) */
#define TR01_L3_PAIRING_KEY_INVALIDATE_PACKET_SIZE TR01_L3_SIZE_SIZE + TR01_L3_PAIRING_KEY_INVALIDATE_RES_SIZE + TR01_L3_TAG_SIZE
...
/** @brief Packet length (incl. RES_SIZE and TAG) */
#define TR01_L3_R_MEM_DATA_READ_PACKET_SIZE_MAX TR01_L3_SIZE_SIZE + TR01_L3_R_MEM_DATA_READ_RES_SIZE_MAX + TR01_L3_TAG_SIZE
...
/** @brief Max packet length (incl. RES_SIZE and TAG) */
#define TR01_L3_RANDOM_VALUE_GET_PACKET_SIZE_MAX TR01_L3_SIZE_SIZE + TR01_L3_RANDOM_VALUE_GET_RES_SIZE_MAX + TR01_L3_TAG_SIZE
