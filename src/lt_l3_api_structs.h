// GENERATED ON 2024-10-10 12:12:20.234188
...
#define LT_L3_PING_CMD_MIN_SIZE 0u
/** Minimal length of field data_in */
#define LT_L3_PING_CMD_DATA_IN_MIN_LEN 0u
/** Maximal length of field data_in */
#define LT_L3_PING_CMD_DATA_IN_MAX_LEN 4096u


/**
 * @brief
 * A dummy cmd_id to check the Secure Channel Session communication.
 */
struct lt_l3_ping_cmd_t {
    u16 cmd_size; /**< L3 packet size */
...
/** @brief Command length */
#define LT_L3_PAIRING_KEY_WRITE_CMD_SIZE 35u
...
/** @brief Command length */
#define LT_L3_PAIRING_KEY_READ_CMD_SIZE 2u
...
/** @brief Command length */
#define LT_L3_PAIRING_KEY_INVALIDATE_CMD_SIZE 2u
...
/** @brief Command length */
#define LT_L3_R_CONFIG_WRITE_CMD_SIZE 7u
...
/** @brief Command length */
#define LT_L3_R_CONFIG_READ_CMD_SIZE 2u
...
/** @brief Command length */
#define LT_L3_R_CONFIG_ERASE_CMD_SIZE 0u
...
/** @brief Command length */
#define LT_L3_I_CONFIG_WRITE_CMD_SIZE 3u
...
/** @brief Command length */
#define LT_L3_I_CONFIG_READ_CMD_SIZE 2u
...
/** @brief Command length */
#define LT_L3_R_MEM_DATA_WRITE_CMD_MIN_SIZE 4u
/** Minimal length of field data */
#define LT_L3_R_MEM_DATA_WRITE_CMD_DATA_MIN_LEN 1u
/** Maximal length of field data */
#define LT_L3_R_MEM_DATA_WRITE_CMD_DATA_MAX_LEN 444u
...
/** @brief Command length */
#define LT_L3_R_MEM_DATA_READ_CMD_SIZE 2u
...
/** @brief Command length */
#define LT_L3_R_MEM_DATA_ERASE_CMD_SIZE 2u
...
/** @brief Command length */
#define LT_L3_RANDOM_VALUE_GET_CMD_SIZE 1u
...
/** @brief Command length */
#define LT_L3_ECC_KEY_GENERATE_CMD_SIZE 3u
...
/** @brief Command length */
#define LT_L3_ECC_KEY_STORE_CMD_SIZE 47u
...
/** @brief Command length */
#define LT_L3_ECC_KEY_READ_CMD_SIZE 2u
...
/** @brief Command length */
#define LT_L3_ECC_KEY_ERASE_CMD_SIZE 2u
...
/** @brief Command length */
#define LT_L3_ECDSA_SIGN_CMD_SIZE 47u
...
/** @brief Command length */
#define LT_L3_EDDSA_SIGN_CMD_MIN_SIZE 16u
/** Minimal length of field msg */
#define LT_L3_EDDSA_SIGN_CMD_MSG_MIN_LEN 1u
/** Maximal length of field msg */
#define LT_L3_EDDSA_SIGN_CMD_MSG_MAX_LEN 4096u
...
/** @brief Command length */
#define LT_L3_MCOUNTER_INIT_CMD_SIZE 7u
...
/** @brief Command length */
#define LT_L3_MCOUNTER_UPDATE_CMD_SIZE 2u
...
/** @brief Command length */
#define LT_L3_MCOUNTER_GET_CMD_SIZE 2u
...
/** @brief Command length */
#define LT_L3_MAC_AND_DESTROY_CMD_SIZE 35u
...
/** @brief Command length */
#define LT_L3_SERIAL_CODE_GET_CMD_SIZE 0u
