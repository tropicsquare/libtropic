...
echo ""
echo ""
openocd -f /home/ppolach/Desktop/libtropic/scripts/test_runner/ts11-swd.cfg -c "init;  ftdi_set_signal SPI_EN 1; ftdi_set_signal PLTF_PWR_EN 1; exit"
sleep .7
...
#echo ""
#echo ""
#openocd -f /home/ppolach/Desktop/libtropic/scripts/test_runner/ts11-swd.cfg \
#-f /usr/share/openocd/scripts/target/stm32l4x.cfg \
#-c "init; ftdi_set_signal PLTF_PWR_EN 1; sleep 500; program ../../tests/platforms/libtropic-stm32/NUCLEO_L432KC/build/stm32_example.elf verify exit"
#sleep .7
...
echo ""
echo ""
openocd -f /home/ppolach/Desktop/libtropic/scripts/test_runner/ts11-swd.cfg -f /usr/share/openocd/scripts/target/stm32l4x.cfg -c "init; reset; exit"
sleep 5
...
echo ""
echo ""
openocd -f /home/ppolach/Desktop/libtropic/scripts/test_runner/ts11-swd.cfg -c "init;  ftdi_set_signal SPI_EN 0; ftdi_set_signal PLTF_PWR_EN 0; exit"
