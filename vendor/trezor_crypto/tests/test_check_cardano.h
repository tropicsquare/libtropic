...
START_TEST(test_bip32_cardano_hdnode_vector_1)
{
    ...
    secret_from_entropy_cardano_icarus((const uint8_t *)"", 0, mnemonic_bits, mnemonic_bits_len / 8,
                                       cardano_secret, NULL);
    hdnode_from_secret_cardano(cardano_secret, &node);

    ck_assert_mem_eq(cardano_secret,
                     fromhex("08a14df748e477a69d21c97c56db151fc19e2521f31dd0ac5360f269e5b6ea46"
    ...
    ck_assert_mem_eq(node.chain_code,
                     fromhex("affbc325d9027c0f2d9f925b1dcf6c12bf5c1dd08904474066a4f2c00db56173"), 32);
    ck_assert_mem_eq(node.private_key,
                     fromhex("08a14df748e477a69d21c97c56db151fc19e2521f31dd0ac5360f269e5b6ea46"), 32);
    ck_assert_mem_eq(node.private_key_extension,
                     fromhex("daeb991f2d2128e2525415c56a07f4366baa26c1e48572a5e073934b6de35fbc"), 32);
    ck_assert_int_eq(hdnode_fill_public_key(&node), 0);
    ck_assert_mem_eq(node.public_key + 1,
                     fromhex("9a1d04808b4c0682816961cf666e82a7fd35949658aba5354c517eccf12aacb4"), 32);
}
END_TEST
...
START_TEST(test_bip32_cardano_hdnode_vector_2)
{
    ...
    ck_assert_mem_eq(node.chain_code,
                     fromhex("104c6a0736e501c9bfe2966ba3773f5320495b19c3f2ed222234850af2ccd5b1"), 32);
    ck_assert_mem_eq(node.private_key,
                     fromhex("6064bf06b2e981d7c9792b1482eeecd40ec3cfa12143f4a1f149d48ce8b6ea46"), 32);
    ck_assert_mem_eq(node.private_key_extension,
                     fromhex("64aa9a16331f14c981b769efcf96addcc4c6db44047fe7a7feae0be23d33bf54"), 32);
    ck_assert_int_eq(hdnode_fill_public_key(&node), 0);
    ck_assert_mem_eq(node.public_key + 1,
                     fromhex("c651c14a13c2311fc30a7acf244add1fdac3683e7ba89b4571e4cbcab509b915"), 32);
}
END_TEST
...
START_TEST(test_bip32_cardano_hdnode_vector_3)
{
    ...
    ck_assert_mem_eq(node.chain_code,
                     fromhex("da99870d7e69de2a76f255ba8c7ed22428c7e5b0a8df978753c707c95ec3d4ca"), 32);
    ck_assert_mem_eq(node.private_key,
                     fromhex("c85fa69f4a1891fd98d1d1fc5f0cf9b1d6e44b0e6906744ab23ea766edb6ea46"), 32);
    ck_assert_mem_eq(node.private_key_extension,
                     fromhex("b4fc241feffe840b8a54a26ab447f5a5caa31032db3a8091fca14f38b86ed539"), 32);
    ck_assert_int_eq(hdnode_fill_public_key(&node), 0);
    ck_assert_mem_eq(node.public_key + 1,
                     fromhex("5a5b0c92530cd366f05cf072509c806f904262c259e79a0080bbd5ee35706bb1"), 32);
}
END_TEST
...
START_TEST(test_bip32_cardano_hdnode_vector_4)
{
    ...
    ck_assert_mem_eq(node.chain_code,
                     fromhex("b40c44dfd9be08591b62be7f9991c85f812d8196927f3c824d9fcb17d275089e"), 32);
    ck_assert_mem_eq(node.private_key,
                     fromhex("d064dcf1449d9c3e47f5b422680343561989035bf2e4e23fc34cb61fedb6ea46"), 32);
    ck_assert_mem_eq(node.private_key_extension,
                     fromhex("a3071959013af95aaecf78a7a2e1b9838bbbc4864d6a8a2295243782078345cd"), 32);
    ck_assert_int_eq(hdnode_fill_public_key(&node), 0);
    ck_assert_mem_eq(node.public_key + 1,
                     fromhex("aaaca5e7adc69a03ef1f5c017ed02879e8ca871df028461ed9bf19fb8fa15038"), 32);
}
END_TEST
...
START_TEST(test_bip32_cardano_hdnode_vector_5)
{
    ...
    ck_assert_mem_eq(node.chain_code,
                     fromhex("2593896baf92f6ab2c0f253787ab16be0244ba95e0d48ba09da1a7fd3f926c72"), 32);
    ck_assert_mem_eq(node.private_key,
                     fromhex("0811b6d5d6f7120cb05d4ce5453d6ce42825c2a8e53b6d370a6b05ccf4b6ea46"), 32);
    ck_assert_mem_eq(node.private_key_extension,
                     fromhex("5bebf1eea68acd04932653d944b064b10baaf5886dd73c185cc285059bf93363"), 32);
    ck_assert_int_eq(hdnode_fill_public_key(&node), 0);
    ck_assert_mem_eq(node.public_key + 1,
                     fromhex("1c87a32c5babad2fe33e0586bdc523574c6126f8368bc76598e17ea46201f980"), 32);
}
END_TEST
...
START_TEST(test_bip32_cardano_hdnode_vector_6)
{
    ...
    ck_assert_mem_eq(node.chain_code,
                     fromhex("fe8c6c2ab1e30385513fcffb49dcfe3e7805260425ea76b3b72b9f5bbe3b3d40"), 32);
    ck_assert_mem_eq(node.private_key,
                     fromhex("6019b9f5ef6ca530b657bcdb500de5455db8d51afb951fa045b6fbb3f6b6ea46"), 32);
    ck_assert_mem_eq(node.private_key_extension,
                     fromhex("466332cb097934b43008701e7e27044aa56c7859019e4eba18d91a3bea23dff7"), 32);
    ck_assert_int_eq(hdnode_fill_public_key(&node), 0);
    ck_assert_mem_eq(node.public_key + 1,
                     fromhex("0b8f04755481ced76b4e5795aaafdb3cbd757c10fe60e9c58f48cf29a7ec3575"), 32);
}
END_TEST
...
START_TEST(test_bip32_cardano_hdnode_vector_7)
{
    ...
    ck_assert_mem_eq(node.chain_code,
                     fromhex("ff77c08d37471c1d4cedd3fae2642c009324d9712492efc74dedab09c9bf973c"), 32);
    ck_assert_mem_eq(node.private_key,
                     fromhex("488f34840bba516f7920f91676b8681d0dd833b4ce14468e0810b255f9b6ea46"), 32);
    ck_assert_mem_eq(node.private_key_extension,
                     fromhex("01eccef768a79859f824a1d3c3e35e131184e2940c3fca9a4c9b307741f65363"), 32);
    ck_assert_int_eq(hdnode_fill_public_key(&node), 0);
    ck_assert_mem_eq(node.public_key + 1,
                     fromhex("148605be54585773b44ba87e79265149ae444c4cc37cb1f8db8c08482fba293b"), 32);
}
END_TEST
...
START_TEST(test_bip32_cardano_hdnode_vector_8)
{
    ...
    ck_assert_mem_eq(node.chain_code,
                     fromhex("6fb22a4531ad79e828c4907c5fff3ecf686c16cb195f81243f1f0330173380e4"), 32);
    ck_assert_mem_eq(node.private_key,
                     fromhex("a0baa34e4e24f0500ed6e5e90ab41984b965b7464b0b28640528778dd8a6b854"), 32);
    ck_assert_mem_eq(node.private_key_extension,
                     fromhex("170e0d3b65ba8d71f27a6db60d0ac26dcb16e52e08cc259db72066f206b258d5"), 32);
    ck_assert_int_eq(hdnode_fill_public_key(&node), 0);
    ck_assert_mem_eq(node.public_key + 1,
                     fromhex("3dae0c06d87db618d73ee808425898cdd882f9eb43bf139c6b3a4760551ee89f"), 32);
}
END_TEST
...
START_TEST(test_bip32_cardano_hdnode_vector_9)
{
    ...
    ck_assert_mem_eq(node.chain_code,
                     fromhex("9b226add79f90086ea18b260da633089fe121db758aa31284ad1affaf3c9bb68"), 32);
    ck_assert_mem_eq(node.private_key,
                     fromhex("38eb2a79486e516cb6658700503a3e2c870c03e9d1aec731f780aa6fb7f7de44"), 32);
    ck_assert_mem_eq(node.private_key_extension,
                     fromhex("80d2c677638e5dbd4395cdec279bf2a42077f2797c9e887949d37cdb317fce6a"), 32);
    ck_assert_int_eq(hdnode_fill_public_key(&node), 0);
    ck_assert_mem_eq(node.public_key + 1,
                     fromhex("115a365b2aad1d8eba7d379de518f1fa8553855110af24e5695011c32ce9a300"), 32);
}
END_TEST
...
START_TEST(test_cardano_ledger_vector_1)
{
    ...
    ck_assert_mem_eq(cardano_secret,
                     fromhex("a08cf85b564ecf3b947d8d4321fb96d70ee7bb760877e371899b14e2ccf88658"
...
START_TEST(test_cardano_ledger_vector_2)
{
    ...
    ck_assert_int_eq(res, 1);
    ck_assert_mem_eq(cardano_secret,
                     fromhex("587c6774357ecbf840d4db6404ff7af016dace0400769751ad2abfc77b9a3844"
...
START_TEST(test_cardano_ledger_vector_3)
{
    ...
    ck_assert_int_eq(res, 1);
    ck_assert_mem_eq(cardano_secret,
                     fromhex("f053a1e752de5c26197b60f032a4809f08bb3e5d90484fe42024be31efcba757"
