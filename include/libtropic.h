#ifndef TS_LIBTROPIC_H
#define TS_LIBTROPIC_H
 ...
 * @return            TS_OK if success, otherwise returns other error code.
 */
ts_ret_t ts_ecc_ecdsa_sign(ts_handle_t *h, const ecc_slot_t slot, const uint8_t *msg_hash, const int16_t msg_hash_len, uint8_t *rs, const int8_t rs_len);
