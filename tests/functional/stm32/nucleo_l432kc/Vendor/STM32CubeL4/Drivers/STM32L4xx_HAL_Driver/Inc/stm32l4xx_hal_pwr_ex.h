...
typedef struct {
    uint32_t
        PVMType; /*!< PVMType: Specifies which voltage is monitored and against which threshold.
                      ...
                      @arg @ref PWR_PVM_1 Peripheral Voltage Monitoring 1 enable: VDDUSB versus 1.2 V
(applicable when USB feature is supported).
@if STM32L486xx
                      @arg @ref PWR_PVM_2 Peripheral Voltage Monitoring 2 enable: VDDIO2 versus 0.9 V
(applicable when VDDIO2 is present on device).
@endif
...
#define PWR_PVM_1                                                                                   \
    PWR_CR2_PVME1 /*!< Peripheral Voltage Monitoring 1 enable: VDDUSB versus 1.2 V (applicable when \
                     USB feature is supported) */
#endif            /* PWR_CR2_PVME1 */
#if defined(PWR_CR2_PVME2)
#define PWR_PVM_2                                                                                   \
    PWR_CR2_PVME2 /*!< Peripheral Voltage Monitoring 2 enable: VDDIO2 versus 0.9 V (applicable when \
                     VDDIO2 is present on device) */
#endif            /* PWR_CR2_PVME2 */
