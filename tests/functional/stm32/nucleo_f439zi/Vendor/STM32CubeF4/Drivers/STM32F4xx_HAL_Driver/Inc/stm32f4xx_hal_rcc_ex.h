...
typedef struct {
    ...
    uint32_t
        PLLI2SQ; /*!< Specifies the division factor for SAI clock.
                      This parameter must be a number between Min_Data = 2 and Max_Data = 15.
...
typedef struct {
    ...
    uint32_t
        PLLSAIQ; /*!< Specifies the division factor for SAI clock.
                      This parameter must be a number between Min_Data = 2 and Max_Data = 15.
...
typedef struct {
    ...
    uint32_t Clk48ClockSelection; /*!< Specifies CLK48 Clock Selection this clock used OTG FS, SDIO and
                                    RNG clocks. This parameter can be a value of @ref
 ...
 *         This parameter can be one of the following values:
 *            @arg RCC_I2SAPB1CLKSOURCE_PLLI2S: PLLI2S VCO output clock divided by PLLI2SR used as I2S
 * clock.
 *            @arg RCC_I2SAPB1CLKSOURCE_EXT: External clock mapped on the I2S_CKIN pin used as I2S APB1
 * clock.
 ...
 * @param  __SOURCE__ specifies the SAI Block A clock source.
 *         This parameter can be one of the following values:
 *            @arg RCC_I2SAPB2CLKSOURCE_PLLI2S: PLLI2S VCO output clock divided by PLLI2SR used as I2S
 * clock.
 *            @arg RCC_I2SAPB2CLKSOURCE_EXT: External clock mapped on the I2S_CKIN pin used as I2S APB2
 * clock.
 ...
 *            @arg RCC_SPDIFRXCLKSOURCE_PLLI2SP: PLLI2S VCO Output divided by PLLI2SP used as SPDIFRX
 * clock.
 */
 ...
 *            @arg RCC_SAIACLKSOURCE_EXT: External clock mapped on the I2S_CKIN pinused as SAI1 Block A
 * clock.
 ...
 *            @arg RCC_SAIBCLKSOURCE_EXT: External clock mapped on the I2S_CKIN pin used as SAI1 Block
 * A clock.
