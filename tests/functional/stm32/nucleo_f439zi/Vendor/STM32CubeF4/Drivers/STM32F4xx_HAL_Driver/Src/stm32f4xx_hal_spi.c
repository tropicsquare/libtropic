/**
  ...
  ******************************************************************************
  ...
  the DMA Tx or Rx Stream/Channel
...
HAL_StatusTypeDef HAL_SPI_DMAStop(SPI_HandleTypeDef *hspi)
{
    ...
    /* The Lock is not implemented on this API to allow the user application
       ...
       HAL_SPI_TxRxCpltCallback(): when calling HAL_DMA_Abort() API the DMA TX/RX Transfer complete
       interrupt is generated and the correspond call back is executed HAL_SPI_TxCpltCallback() or
