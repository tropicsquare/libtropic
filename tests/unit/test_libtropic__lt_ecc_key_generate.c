...
void test_lt_ecc_key_generate__cmd_size_mismatch()
{
    ...
    lt_ecc_key_generate_cmd_size_inject_value = 0;
    ...
    lt_ecc_key_generate_cmd_size_inject_value = 2;
    lt_l3_cmd_Stub(callback_lt_ecc_key_generate_lt_l3_cmd);
    TEST_ASSERT_EQUAL(LT_FAIL, lt_ecc_key_generate(&h, ECC_SLOT_1, CURVE_ED25519));

    lt_ecc_key_generate_cmd_size_inject_value = (uint16_t)((rand() % (L3_PACKET_MAX_SIZE - 2)) + 2);
    lt_l3_cmd_Stub(callback_lt_ecc_key_generate_lt_l3_cmd);
    TEST_ASSERT_EQUAL(LT_FAIL, lt_ecc_key_generate(&h, ECC_SLOT_1, CURVE_ED25519));
}
...
void test_lt_ecc_key_generate__correct()
{
    ...
    lt_ecc_key_generate_cmd_size_inject_value = 1;
    lt_l3_cmd_Stub(callback_lt_ecc_key_generate_lt_l3_cmd);
