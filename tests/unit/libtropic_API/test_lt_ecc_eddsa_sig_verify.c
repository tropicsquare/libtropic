...
{
    TEST_ASSERT_EQUAL(LT_PARAM_ERR, lt_ecc_eddsa_sig_verify(NULL, LT_L3_EDDSA_SIGN_CMD_MSG_LEN_MIN, (uint8_t*)"", (uint8_t*)""));
}
...
{
    uint8_t msg[LT_L3_EDDSA_SIGN_CMD_MSG_LEN_MAX + 1];
