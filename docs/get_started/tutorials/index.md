# Tutorials
To quickly get you started on your host platform, we prepared tutorials.

First, we recommend starting with our 📜 [TROPIC01 Model Tutorial](tropic01_model/index.md).
...
Continue with the [📜 TROPIC01 Model Tutorial](tropic01_model/index.md).
