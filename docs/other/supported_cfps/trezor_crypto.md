...
!!! warning
    We strongly advise users that want to use Trezor Crypto in their application to **not** use our out-of-date copy of Trezor Crypto inside `vendor/`, but use the version found in the [Trezor Firmware repository](https://github.com/trezor/trezor-firmware) instead and handle the dependency themselves.
