...
3. Most of the Libtropic's [Available CMake Options](../../get_started/integrating_libtropic/how_to_configure/index.md#available-cmake-options) — they will be propagated to Libtropic's CMake by the model's CMake.
